        ...
        <div class="mt-10">
          <div class="relative">
            <div class="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
              <img src="@/assets/img/location-icon.svg" alt="Icon Location" width="15" height="13" />
            </div>
            <input type="search" id="default-search" class="block w-full p-4 pl-10 py-6 text-base text-gray-900 border-0 rounded-full bg-[#FDFEFF] focus:ring-orange-600 focus:border-orange-600 shadow" placeholder="Search Destination..." required>
            <button type="submit" class="text-white absolute right-3 bottom-3 bg-[#F66F4D] hover:bg-[#db5230] focus:ring-4 focus:outline-none focus:ring-orange-600 font-medium rounded-full text-sm px-3 py-3" aria-label="Booking Now">
