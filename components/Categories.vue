<template>
  <div class="mb-10">
    ...
    <div class="flex lg:flex-row mt-10 justify-between">
      <!-- Looping disini -->
      <div v-for="item in 6" :key="item">
        <img src="@/assets/img/categories-1.svg" alt="Beach" />
        <p class="text-center font-medium text-xl mt-2 tracking-wider">{{ 'Beach' }}</p>
      </div>
    </div>
  </div>
</template>
